...
- [Yahoo Finance Style Stock Price Label in SwiftUI (EN)](https://hackernoon.com/yahoo-finance-style-stock-price-label-in-swiftui)
- [An elegant way to organize communication between view and view controller (EN)](https://dev.to/prokhorovxo/an-elegant-way-to-organize-communication-between-view-and-view-controller-10i2)
